...
#public:
	...
	static function onMouseDown(self, btn)
	{
		...
		if (!panel.m_isTabsMovementEnabled)
			return
...
class GUI.TabPanel extends classes(GUI.Texture, GUI.Orientable)
{
#private:
	m_isTabsMovementEnabled = true
...
#public:
	...
	{
		return m_isTabsMovementEnabled
	}

	function setTabsMovement(movement)
	{
		m_isTabsMovementEnabled = movement
	}
	...
	function setSizePx(width, height)
	{
		...
		width -= m_marginPx.x * 2
		height -= m_marginPx.y * 2
